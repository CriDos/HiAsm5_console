...
protected:
     ...
     * Draw select frame
     */
    virtual void drawSelect(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
    /**
     * Draw property value
     */
    virtual void drawValue(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
public:
     ...
     * Draw property
     */
    virtual void draw(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
...
public:
    ...
    void draw(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
};
...
public:
    ...
    void draw(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
    inline void setIcon(TypePixbuf icon)
    {
        this->icon = icon;
    }
};
...
public:
    ...
    {
        *(int *)this->value = atoi(value.c_str());
    }
};
...
public:
    ...
    ustring editText()
    {
        return double_to_str(*(double *)value);
    }
    void setValue(const ustring &value)
    {
        *(double *)this->value = atof(value.c_str());
    }
};
...
public:
    ...
    ustring editText()
    {
        return *(ustring *)value == "" ? emptyName : *(ustring *)value;
    }
    void setValue(const ustring &value)
    {
        *(ustring *)this->value = value == emptyName ? "" : value;
    }
    void drawValue(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
};
...
public:
    ...
    ustring editText()
    {
        return ((Gdk::Color *)value)->to_string();
    }
    void setValue(const ustring &value)
    {
        ((Gdk::Color *)this->value)->set(value);
    }
    void drawValue(DrawContext dc, Glib::RefPtr<Style> style, int x, int y);
};
...
public:
    ...
    ustring editText()
    {
        return ((ArrayValue *)value)->empty() ? emptyName : int_to_str(((ArrayValue *)value)->size());
    }
};
...
class PropEditor : public DrawingArea
{
private:

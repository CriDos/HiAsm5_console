...
public:
    ...
    void prepareForRun(Widget **parent)
    {
        value.clear();
    }
...
public:
    ...
    ElementPoint *getRealPoint(ElementPoint *point)
    {
        return points[3]->point;
    }
...
public:
    ...
    void _arr_set(TData &index, TData &data)
    {
        list[index.toInt()] = data.toStr();
    }
    TData _arr_get(TData &index)
    {
        return list[index.toInt()];
    }
    void _arr_add(TData &data)
    {
        list << data;
    }
};
...
public:
    ...
    void _arr_set(TData &index, TData &data)
    {
        list->children()[index.toInt()][listColumns.text] = data.toStr();
    }
    TData _arr_get(TData &index)
    {
        return ustring(list->children()[index.toInt()][listColumns.text]);
    }
    void _arr_add(TData &data)
    {
        (*list->append())[listColumns.text] = data;
    }
};

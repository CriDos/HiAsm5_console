...
extern Gdk::Color lightColor;
extern Gdk::Color darkColor;
extern Gdk::Color hintColor;
...
protected:
    ...
    Gdk::Color *color, colorLight, colorDark;
...
public:
    ...
    virtual bool mouseDown(gdouble x, gdouble y, int button)
    {
        return false;
    }
    virtual void mouseMove(gdouble x, gdouble y) {}
    virtual void mouseUp(gdouble x, gdouble y, int button) {}
    virtual int mouseCursor(gdouble x, gdouble y)
    {
        return 0;
    }
     ...
     * @return point if found, else NULL
     */
    inline ElementPoint *getPointByName(const ustring &name)
    {
        return points.getByName(name);
    }
    /**
     ...
     */
    virtual ElementPoint *getRealPoint(ElementPoint *point)
    {
        return point;
    }
    ...
    bool isMainELink()
    {
        return isELink() && *elinkList->begin() == this;
    }
    /**
     * Return owner of linked list
     * @return first item from linked list
     */
    inline Element *getMainELink()
    {
        return *elinkList->begin();
    }
    ...
    {
        return flag & ELEMENT_FLG_IS_SELECT;
    }
    /**
    ...
    {
        return flag & ELEMENT_FLG_IS_PARENT;
    }
    /**
    ...
    inline bool isCore()
    {
        return flag & ELEMENT_FLG_IS_CORE;
    }
    /**

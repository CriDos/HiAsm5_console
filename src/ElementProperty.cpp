...
void DataValue::copyValue(DataType type, void *dest, void *value)
{
    ...
    case data_data:
        *(TData *)dest = *(TData *)value;
        break;
    case data_color:
        *(Gdk::Color *)dest = *(Gdk::Color *)value;
        break;
    case data_pixbuf:
...
ustring DataValue::serialize(DataType type, void *value)
{
    ...
    case data_combo:
    case data_comboEx:
        return int_to_str(*(int *)value);
    case data_stock:
    case data_element:
        return ustring("\"") + *(ustring *)value + "\"";
    case data_real:
    ...
    case data_str:
    case data_list:
        return serializeStrList(value);
    case data_color:
        return ((Gdk::Color *)value)->to_string();
    case data_pixbuf:
        return serializePixbuf(value);
    case data_array:
    ...
    case data_data: {
        ...
        for(int t = 0; t < 3; t++)
            if(strncmp(text.c_str(), dataNames[dtypes[t]], i = strlen(dataNames[dtypes[t]])) == 0) {
                ...
                switch(t) {
                case 0:
                    *(TData *)value = atoi(s.c_str());
                    break;
                case 1:
                    *(TData *)value = s;
                    break;
                case 2:
                    *(TData *)value = atof(s.c_str());
                    break;
                }
            }
        break;
...
bool ElementProperty::isDefault()
{
    ...
    case data_combo:
    case data_comboEx:
        return *(int *)value == *(int *)defValue;
    case data_stock:
    case data_str:
    case data_element:
    case data_list:
        return *(ustring *)value == *(ustring *)defValue;
    case data_real:
        return *(double *)value == *(double *)defValue;
    case data_data:
        return *(TData *)value == *(TData *)defValue;
    case data_pixbuf:
        return *(TypePixbuf *)value == *(TypePixbuf *)defValue;
    case data_color:
        return *(Gdk::Color *)value == *(Gdk::Color *)defValue;
    case data_array:
        return ((ArrayValue *)value)->empty();
    case data_font:
        return *(FontRecord *)value == *(FontRecord *)defValue;
    default:
        return false;
    }
}
...
void ElementProperty::setAsDefault()
{
    ...
    case data_combo:
    case data_comboEx:
        *(int *)defValue = *(int *)value;
        break;
    case data_stock:
    case data_str:
    case data_element:
    case data_list:
        *(ustring *)defValue = *(ustring *)value;
        break;
    case data_real:
        *(double *)defValue = *(double *)value;
        break;
    case data_data:
        *(TData *)defValue = *(TData *)value;
        break;
    case data_pixbuf:
        *(TypePixbuf *)defValue = *(TypePixbuf *)value;
        break;
    case data_color:
        *(Gdk::Color *)defValue = *(Gdk::Color *)value;
        break;
    case data_font:
        *(FontRecord *)defValue = *(FontRecord *)value;
        break;
    default:
        ;
    }
